...
# createing the database using declarative_base subclass
...
jessica_rydberg = Programmer(
    first_name="Jessica",
    last_name="Rydberg",
    gender="F",
    nationality="Swedish",
    famous_for="Jess clothing"
)
...
# delete multiple record, in this case all records
